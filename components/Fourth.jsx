    ...
    <div className='bg-[rgb(248,249,250)]'>
      <div className='md:mt-[6rem] '>
            ...
            1
                        ...
                        <h5 class="mb-2 text-[1.3rem] font-bold tracking-tight text-black">Sign up for an account</h5>
            ...
            2
                        ...
                        <h5 class="mb-2 text-[1.3rem] font-bold tracking-tight text-black">Choose a account or card</h5>
                        <p class="font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis neque sollicitudin nulla sit.</p>
                    </a>
            ...
            3
                        ...
                        <h5 class="mb-2 text-[1.3rem] font-bold tracking-tight text-black">Accomplish your goals.</h5>
                        <p class="font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis neque sollicitudin nulla sit.</p>
                    </a>
