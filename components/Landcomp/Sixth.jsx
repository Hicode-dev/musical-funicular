...
const Sixth = () => {
  return (
    <div>
              <div>
            <div className="text w-full mb-10 px-6">
                <h3 className='md:max-w-[30rem] font-bold text-[2rem ] md:text-[2.5rem]'>We’ve helped our members in a big way.</h3>      
            </div>

            <div className="whole grid grid-cols-1 place-content-center place-items-center md:grid-cols-4 gap-y-5">
                <div className="c1">
