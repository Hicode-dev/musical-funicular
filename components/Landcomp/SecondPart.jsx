            ...
            <div className="whole grid grid-cols-1 md:grid-cols-2 gap-y-5">
                <div className="c1">
                    ...
                    <a href="#" className="block max-w-sm p-6   text-black  ">
                        ...
                        <h5 className="mb-2 text-[1.3rem] font-bold tracking-tight text-black">Great customer service</h5>
                ...
                <div className="c1">
                    ...
                    <a href="#" className="block max-w-sm p-6   text-black ">
                        ...
                        <h5 className="mb-2 text-[1.3rem] font-bold tracking-tight text-black">Free weekly report monitoring.</h5>
                        <p className="font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis neque sollicitudin nulla sit.</p>
                    </a>
                ...
                <div className="c1">
                    ...
                    <a href="#" className="block max-w-sm p-6   text-black ">
                        ...
                        <h5 className="mb-2 text-[1.3rem] font-bold tracking-tight text-black">Free credit improvement tips.</h5>
                        <p className="font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis neque sollicitudin nulla sit.</p>
                    </a>
                ...
                <div className="c1">
                    ...
                    <a href="#" className="block max-w-sm p-6   text-black  ">
                        ...
                        <h5 className="mb-2 text-[1.3rem] font-bold tracking-tight text-black">Security with 256-bit encryption..</h5>
                        <p className="font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis neque sollicitudin nulla sit.</p>
                    </a>
